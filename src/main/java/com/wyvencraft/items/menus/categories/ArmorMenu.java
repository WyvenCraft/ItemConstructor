...
public class ArmorMenu extends ItemMenu {
    public ArmorMenu(List<Item> itemList) {
        super(itemList);
    }

    enum Type {
        HELMET(ItemStackBuilder.from(Material.GOLDEN_HELMET).setName("&eHelmets", true), ItemType.HELMET, SlotPos.of(1, 0)),
        CHEST(ItemStackBuilder.from(Material.GOLDEN_CHESTPLATE).setName("&eChestplates", true), ItemType.CHEST, SlotPos.of(2, 0)),
        LEGS(ItemStackBuilder.from(Material.GOLDEN_LEGGINGS).setName("&eLeggings", true), ItemType.LEGS, SlotPos.of(3, 0)),
        BOOTS(ItemStackBuilder.from(Material.GOLDEN_BOOTS).setName("&eBoots", true), ItemType.FEET, SlotPos.of(4, 0));
